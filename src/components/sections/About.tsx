...
const About = ({ translations }: { translations: Translations }) => {
    ...
    return (
        <section className="pb-12 px-4 text-foreground">
            <div className="container mx-auto max-w-4xl">
                <div className="flex items-center gap-4 my-6 p-6 bg-primary/5 backdrop-blur rounded-2xl border border-primary/30 hover:bg-primary/10 transition-all duration-300">
                ...
                <div className='text-light space-y-4 p-6 bg-dark/5 backdrop-blur rounded-2xl border border-primary/30 hover:bg-dark/10 transition-all duration-300'>
